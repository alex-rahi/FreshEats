...
from app.api import admin, auth, moderation, profiles, recipes, social
...
app = FastAPI(
    title="FreshEats API",
    description="Backend for FreshEats — grid-style recipe sharing with YOLO moderation",
    version="1.0.0",
    lifespan=lifespan,
    docs_url="/docs",
    redoc_url="/redoc",
