...
PLACEHOLDER_RECIPES: list[RecipeResponse] = [
    RecipeResponse(
        ...
        like_count=128,
        comment_count=14,
        image_url=_IMAGE.format(id="1546069901-ba9599a7e63c"),
    ...
    RecipeResponse(
        ...
        like_count=96,
        comment_count=8,
        image_url=_IMAGE.format(id="1467003909585-2f8a7a6c9795"),
    ...
    RecipeResponse(
        ...
        like_count=210,
        comment_count=22,
        image_url=_IMAGE.format(id="1509440158856-bfa9e3a4a0a6"),
    ...
    RecipeResponse(
        ...
        like_count=77,
        comment_count=9,
        image_url=_IMAGE.format(id="1490645935967-10de646d83d2"),
        author=UserProfile(id=UUID("00000000-0000-4000-8000-000000000003"), username="chef_leo", display_name="Leo"),
